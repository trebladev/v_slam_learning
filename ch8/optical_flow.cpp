...
int main(int argc,char **argv){
    ...
    //use single level LK in the validation picture
    ...
    vector<uchar> status;
    vector<float> error;
    TIMER_START(opencv_optical_flow);
    cv::calcOpticalFlowPyrLK(img1,img2,pt1,pt2,status,error);
    TIMER_END(opencv_optical_flow);
